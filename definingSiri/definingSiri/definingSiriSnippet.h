...
#error iOSOpenDev Post-Template Project Creation Requirement (remove these lines after completed) -- \
 Add a Copy Bundle Resources Build Phase to compile definingSiriNib.xib: \
 (1) go to TARGETS > Build Phases > Add Build Phase > Add Copy Bundle Resources, drag and drop definingSiriNib.xib into the Copy Bundle Resources item list \
 (2) drag and drop the Copy Bundle Resources Build Phase so that it is ABOVE the Run Script Build Phase

@interface definingSiriSnippet : NSObject<SESnippet> {
    UIView* _view;
